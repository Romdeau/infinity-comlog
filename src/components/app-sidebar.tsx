            ...
            <SidebarMenuButton size="lg" asChild>
              <Link to="/">
                ...
                <div className="flex flex-col gap-0.5 leading-none">
                  ...
                  <span className="text-xs text-muted-foreground">vN5.0</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
      ...
      <SidebarFooter>
        <SidebarMenu>
          ...
          <SidebarMenuItem className="px-2 py-2 group-data-[collapsible=icon]:hidden">
            <div className="flex gap-2 rounded-md bg-muted/50 p-2 text-[10px] leading-tight text-muted-foreground">
              <InfoIcon className="size-3 shrink-0" />
              <span>
                Community tool. Not affiliated with Corvus Belli.
              </span>
            </div>
          </SidebarMenuItem>
          <SidebarMenuItem>
